...
import           JS.Visualizers                     (getVisualizersLibraryPaths)
...
loadGraph location prevSettings retrieveLocation = do
    resetGraph
    visLibPaths <- liftIO $ getVisualizersLibraryPaths
    modifyNodeEditor $ visualizersLibPaths .= uncurry VisualizersPaths visLibPaths
