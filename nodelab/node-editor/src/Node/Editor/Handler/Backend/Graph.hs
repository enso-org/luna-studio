module Node.Editor.Handler.Backend.Graph
    ( handle
    ) where
...
import           Node.Editor.Action.Basic                     (createGraph, localAddConnection, localAddExpressionNode, localAddPort,
...
import           Node.Editor.Action.Basic.Revert              (revertAddConnection, revertAddNode, revertAddPort, revertAddSubgraph,
...
import           Node.Editor.Action.Basic.UpdateCollaboration (bumpTime, modifyTime, refreshTime, touchCurrentlySelected, updateClient)
import           Node.Editor.Action.Batch                     (collaborativeModify, getProgram, requestCollaborationRefresh)
import           Node.Editor.Action.Camera                    (centerGraph)
import           Node.Editor.Action.Command                   (Command)
import           Node.Editor.Action.State.App                 (setBreadcrumbs)
import           Node.Editor.Action.State.Graph               (inCurrentLocation, isCurrentLocation)
import           Node.Editor.Action.State.NodeEditor          (modifyExpressionNode, updateMonads)
import           Node.Editor.Action.UUID                      (isOwnRequest)
import qualified Node.Editor.Batch.Workspace                  as Workspace
import           Node.Editor.Event.Batch                      (Event (..))
import qualified Node.Editor.Event.Event                      as Event
import           Node.Editor.Handler.Backend.Common           (doNothing, handleResponse)
import           Luna.Prelude
