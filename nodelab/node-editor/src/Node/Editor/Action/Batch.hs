module Node.Editor.Action.Batch  where
...
import           Node.Editor.Action.UUID              (registerRequest)
import qualified Node.Editor.Batch.Connector.Commands as BatchCmd
...
import           Node.Editor.State.Global             (State, backend, clientId, workspace)
