...
module Node.Editor.Action.Searcher where
...
import           Node.Editor.Action.Basic                    (createNode, setNodeExpression)
...
import           Node.Editor.Action.State.NodeEditor         (getSearcher, getSelectedNodes, getSelectedNodes, modifyNodeEditor,
                                                              modifySearcher)
import           Node.Editor.Action.State.Scene              (translateToScreen, translateToWorkspace)
...
import           Node.Editor.State.Action                    (Action (begin, continue, end, update), Searcher (Searcher), searcherAction)
