...
module Node.Editor.React.View.Sidebar
    ( sidebar_
    , focusPortLabel
    ) where
...
import           Node.Editor.React.Model.Constants        (lineHeight)
import qualified Node.Editor.React.Model.Field            as Field
import           Node.Editor.React.Model.Node.SidebarNode (NodeLoc, SidebarMode (AddRemove, MoveConnect), SidebarNode, countProjectionPorts,
                                                           frozenHeight, isInputSidebar)
import qualified Node.Editor.React.Model.Node.SidebarNode as SidebarNode
import           Node.Editor.React.Model.Port             (AnyPort, OutPortIndex (Projection), getPortNumber, getPositionInSidebar,
...
import           Node.Editor.React.View.Port              (handleClick, handleMouseDown, handleMouseUp, jsShow2)
import           Node.Editor.React.View.Style             (plainPath_, plainRect_)
