...
module Node.Editor.React.View.PortControl
    ( portControl_
    ) where
...
import           Luna.Prelude          hiding (group)
...
import           Node.Editor.React.Model.Port (InPort)
...
import           Node.Editor.State.Action     (InitValue (Continous, Discrete))
