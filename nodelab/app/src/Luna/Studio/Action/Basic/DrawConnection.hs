...
redrawConnection connId = Graph.getConnection connId >>=
...
redrawConnectionsForNode nid = Graph.getConnectionsContainingNode nid >>=
...
redrawConnectionsForNodes nodeIds = mapM Graph.getConnectionsContainingNode nodeIds >>=
    (fmap . map) (view connectionId) . filterM drawConnection . join


redrawConnectionsForEdgeNodes :: Command State [ConnectionId]
redrawConnectionsForEdgeNodes = Graph.getEdgeNodes >>=
