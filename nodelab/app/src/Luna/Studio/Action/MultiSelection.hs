...
import           Luna.Studio.Action.Graph             (focusNodes, modifySelectionHistory, selectNodes, selectedNodes, unselectAll)
...
stopMultiSelection _ = do
    ...
    selectedNodeIds <- map (^. NodeModel.nodeId) <$> selectedNodes
    focusNodes selectedNodeIds
    modifySelectionHistory selectedNodeIds
