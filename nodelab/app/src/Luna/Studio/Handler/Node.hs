...
import           Luna.Studio.Action.Basic            (enterNode, localSetPortDefault, localToggleVisualizations, removeSelectedNodes,
...
handle (UI (NodeEvent (Node.Enter            nodeId))) = Just $ withJustM (getNode nodeId) enterNode
