...
connect endPoints graphLocation srcNodeId outPort dstNodeId inPort = sendToBus endPoints $ Connect.Request graphLocation (Connect.PortConnect (OutPortRef srcNodeId outPort) (InPortRef dstNodeId inPort))
