...
import           Luna.Studio.Action.Basic           (loadGraph)
import qualified Luna.Studio.Action.Batch           as BatchCmd (closeFile, openFile, saveFile, setProject)
...
-- setProject :: Project -> Command State ()
-- setProject project = loadProject project
